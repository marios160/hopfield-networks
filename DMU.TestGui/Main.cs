...
namespace DMU.Samples
{
    public partial class Main : Form
    {
        ...
        {
            HopfieldRec frm = new HopfieldRec();
            frm.Cols = 2;
            frm.Rows = 2;
            frm.MdiParent = this;
            frm.Show();
        ...
        private void x5MatrixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            HopfieldRec frm = new HopfieldRec();
            frm.Cols = 5;
            frm.Rows = 5;
        ...
        private void x10MatrixToolStripMenuItem_Click(object sender, EventArgs e)
        {
            HopfieldRec frm = new HopfieldRec();
            frm.Cols = 10;
            frm.Rows = 10;
        ...
        private void saveWeightDataToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.Filter = "Train Data (*.csv)|*.csv|All Files (*.*)|*.*";
            ...
            HopfieldRec frm = (HopfieldRec)this.ActiveMdiChild;
        ...
        private void loadTrainDataToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string fileName = string.Empty;
            int rowCount = 0;
            int columnCount = 0;
            ...
            openFileDialog.Filter = "Train Data (*.csv)|*.csv|All Files (*.*)|*.*";
            ...
            if (!string.IsNullOrWhiteSpace(fileName))
            {
                ...
                Matrix trainData = (new Matrix(patternData, rowCount, columnCount));

                HopfieldRec frm = new HopfieldRec();
                frm.Cols = (int)System.Math.Sqrt(rowCount); 
                frm.Rows = frm.Cols;
                frm.TrainData = trainData;
