...
{
    public partial class HopfieldRec : Form
    {
        public HopfieldRec()
        {
            InitializeComponent();
        ...
        private void HopfieldRec_Paint(object sender, PaintEventArgs e)
        {
            DrawGrid(e.Graphics);
        }

        private void HopfieldRec_Load(object sender, EventArgs e)
        {
            //sort out the cell size
            _cellSize = 400 / this.Cols;

            //resize the form and position the controls
            this.Width = this.Cols * _cellSize + 15;
        ...
        /// <param name="e"></param>
        private void HopfieldRec_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void HopfieldRec_MouseMove(object sender, MouseEventArgs e)
        {
            //get the x/y co-ordinates
            int x = Convert.ToInt32(e.X / _cellSize);
            int y = Convert.ToInt32(e.Y / _cellSize);
